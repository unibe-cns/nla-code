...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train network reproduce iEEG data using a fully-recurrent network.')
    ...
    dataset_id = 1
    experiment_duration = 4000
    unclamped_neurons = 10

    network_params = NetworkParams()
    network_params.load_params("recurrent_params.json")
