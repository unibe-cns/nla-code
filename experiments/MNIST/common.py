...
def get_digits_from_class(images, labels, target_size: int, digit_class: int, samples_qty: int, activation_is_sigmoid: bool = False):
    """
    ...
    dataset = [[digit.flatten(), label] for digit in digits]  # make M x 1 array and combine with label
